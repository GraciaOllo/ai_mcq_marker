...
class AIMCQProcessor:
    def __init__(self):
        # Initialize the bubble detector model
    ...
    def is_bubble_filled(self, bubble_img):
        ...
        # For demo purposes, using a simpler approach
        # In a real implementation, you would:
        # 1. Use the prepared model to predict
        # 2. Return the prediction
        
        # Simple method without needing a trained model:
    ...
    def organize_bubbles_into_grid(self, bubbles, num_questions, options_per_row):
        ...
        # Estimate row height by finding average vertical gap
        ...
        if y_diffs:
            # Use clustering or threshold to find the most common gap
            ...
            # Handle the case with too few bubbles
        ...
        for i, bubble in enumerate(bubbles):
            if i == 0:
                ...
                # If this bubble is in the same row as the previous one
    ...
    def process_answer_sheet(self, image_path, num_questions, options_per_question):
        ...
        # Segment the answer sheet to find the grid
        grid_contour, thresh = self.segment_answer_sheet(img)
        
        # Detect bubbles
        bubbles = self.detect_bubbles(img, thresh, grid_contour)
        
        # Organize bubbles into a grid (rows = questions, columns = options)
